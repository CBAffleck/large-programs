...
//                    System.out.println("\n");
    ...
    private void checkUnderTile(JButton[][] guiBoard, int[][] board, int[][] visitedBoard, int x, int y, int numUnderTile, int colNum) {
        ...
        guiBoard[x][y].setIcon(new ImageIcon(new ImageIcon(MinesweeperBoard.class.getResource("" + numUnderTile + "_icon.png")).getImage().getScaledInstance(MinesweeperBoard.iconWidth,MinesweeperBoard.iconHeight, Image.SCALE_SMOOTH), "touched"));
    }
